...
% Leuven.
%
% Salini, S., Laurini, F., Morelli, G., Riani M. and Cerioli A. (2022),
% Covariance matrices of S robust regression estimators, Journal of
...
k2=covrob2./covrob;
Coeffvar=sqrt((sqrt(k2(1,1))-1)*n/p);
if Coeffvar>4
    covrobc=covrob;
else
    covrobc=covrob2;
